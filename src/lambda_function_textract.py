...
1. Resource name (the person's name at the top)
...
def lambda_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        # Step 1: Extract metadata (name, dates) with Claude
                ...
                for col_idx, day_idx in day_columns.items():
                    ...
                    if cell_text:
                        try:
                            ...
                            if hours > 0:
                                projects[current_project]['hours_by_day'][day_idx]['hours'] = str(hours)
                                print(f"  {['Mon','Tue','Wed','Thu','Fri','Sat','Sun'][day_idx]}: {hours}h")
